  ...
  const sendPan = () => {
    ...
    fetch(
      ...
      .then(result => {
        ...
        fetch(
          'https://2d2b-117-250-3-86.in.ngrok.io/account/startup/',
          requestOptions2,
        )
          .then(response => response.text())
          .then(result => {
...
const PatentNumber = ({}) => {
  ...
  const sendPatent = async () => {
    ...
    fetch(
      'https://2d2b-117-250-3-86.in.ngrok.io/account/patentverify/',
      requestOptions,
    )
      .then(response => response.text())
      .then(result => console.log(result))
...
const AddStartups = ({navigation}) => {
  ...
  const sendData = async () => {
    ...
    fetch(
      'https://2d2b-117-250-3-86.in.ngrok.io/account/entrepreneur/',
      requestOptions,
    )
      .then(response => response.text())
      .then(result => console.log(result))
