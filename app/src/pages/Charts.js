...
export default function Charts() {
    ...
    const fetchData = async () => {
        ...
        fetch("https://2d2b-117-250-3-86.in.ngrok.io/news/Top25Fundedcompanybargraphapi/", requestOptions)
    ...
    const fetchGraphs = async () => {
        ...
        fetch("https://2d2b-117-250-3-86.in.ngrok.io/news/Fundingperregionbargraphapi/", requestOptions)
            .then(response => response.text())
            .then(result => console.log(result))
            .catch(error => console.log('error', error));
    }
