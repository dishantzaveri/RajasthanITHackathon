...
const Mentors = ({navigation}) => {
  ...
  const getMentorsList = async () => {
    ...
    var config = {
      method: 'get',
      url: 'https://0b6f-2405-201-6-4da9-e9be-1c7e-2e6a-89a9.in.ngrok.io/account/mentors_list/',
      headers: {
  ...
  const getSearchedMentors = async () => {
    ...
    var config = {
      method: 'post',
      url: 'https://0b6f-2405-201-6-4da9-e9be-1c7e-2e6a-89a9.in.ngrok.io/account/search_mentors/',
      headers: myHeaders,
      data: data,
    };
