    ...
    <div className="px-12 py-2 bg-[#D8E8EB] flex justify-between items-center border-b">
      ...
      {/* {token && (
				<div className="px-64 flex flex-row justify-between items-center flex-1">
					...
					<Link to="/feed">
						<h1 className="font-medium text-xl"><label>{t('home')}</label></h1>
					</Link>

					<Link to="/mentors">
						<h1 className="font-medium text-xl"><label>{t('startups')}</label></h1>
					</Link>

					<Link to="/chat">
						<h1 className="font-medium text-xl"><label>{t('chat')}</label></h1>
					</Link>

					<Link to="/myProfile">
						<h1 className="font-medium text-xl"><label>{t('profile')}</label></h1>
					</Link>
      ...
      {token ? (
        <div className="flex flex-row justify-end items-center flex-1 gap-8">
          ...
          {is_mentor ? (
            ...
            <Link to="/mentors">
              <h1 className="font-medium text-xl">{t("mentors")}</h1>
            </Link>
          )}
